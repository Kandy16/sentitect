...
def run(args):
    ...
    try:
        ...
        runObj.download_file(name='outputs/sentitect-best-model-pkl.pkl', 
                         output_file_path=os.path.join(args.data_path, 'sentitect-best-model-pkl.pkl'))
    except Exception as e:
        print(e)
    ...
    try:
        ...
        runObj.download_file(name='sentitect-best-model-pkl.pkl', 
                         output_file_path=os.path.join(args.data_path, 'sentitect-best-model-pkl.pkl'))
    except Exception as e:
        print(e)
    ...
    try:
        ...
        runObj.download_file(name='sentitect-best-model-pkl.pkl', 
                         output_file_path=args.data_path)
    except Exception as e:
        print(e)        
    ...
    try:
        ...
        runObj.upload_file(name='sentitect-best-model-pkl.pkl', 
                         path_or_stream=os.path.join(args.data_path, 'sentitect-best-model-pkl.pkl'))
    except Exception as e:
        print(e)
    ...
    try:
        ...
        runObj.upload_file(name='outputs/sentitect-best-model-pkl.pkl', 
                         path_or_stream=os.path.join(args.data_path, 'sentitect-best-model-pkl.pkl'))
    except Exception as e:
        print(e)
